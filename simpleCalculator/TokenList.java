...
public class TokenList extends ArrayList<Token>
{
    ...
    private ExpParseTree F() throws SyntaxErrorException {
        ...
        if (idx == size()) {
            // Syntax error!!!
            throw new
                SyntaxErrorException("a number or - or (",
                                     "nothing");
        }
        t1 = get(idx++);
        switch (t1.getName()) {
        ...
        case MINUS:
            if (idx == size()) {
                // Syntax error!!!
                throw new
                    SyntaxErrorException("a number or (",
                                         "nothing");
            }
            t2 = get(idx++);
            switch (t2.getName()) {
            ...
            default:
                // Syntax error!!!
                throw new
                    SyntaxErrorException("a number or (",t2);
            }
        default:
            // Syntax error!!!
            throw new
                SyntaxErrorException("a number or - or (",t1);
        }
    }
    ...
    private ExpParseTree E() throws SyntaxErrorException {
        ...
        if (idx != size()) {
            ...
            throw new
                SyntaxErrorException("One exp in one line!"
